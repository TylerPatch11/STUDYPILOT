...
export default function Button({
  ...
  const variants = {
    ...
    outline: 'border-2 border-gray-300 text-text-primary hover:bg-gray-50 focus:ring-gray-500',
    ghost: 'text-text-secondary hover:bg-gray-100 focus:ring-gray-500',
  }
